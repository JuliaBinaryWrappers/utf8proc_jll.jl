...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import utf8proc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("00992c89-a35c-5347-9984-e6609dacc59a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "utf8proc", artifacts_toml) for e in artifacts["utf8proc"]]
...
if best_platform === nothing
    @debug("Unable to load utf8proc; unsupported platform $(triplet(platform_key_abi()))")
else
